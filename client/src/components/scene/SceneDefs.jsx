...
export default function SceneDefs({ base, wall }) {
  ...
  return (
    <defs>
      ...
      {/* ── RAILING ── */}
      <linearGradient id="g-rail-black" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0%" stopColor="#3A3A38" />
        <stop offset="25%" stopColor="#424240" />
        <stop offset="70%" stopColor="#20201E" />
        <stop offset="100%" stopColor="#121210" />
      </linearGradient>
      <linearGradient id="g-rail-white" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0%" stopColor="#FFFFFF" />
        <stop offset="35%" stopColor="#FAFAFA" />
        <stop offset="80%" stopColor="#DCDCD8" />
        <stop offset="100%" stopColor="#C4C4C0" />
      </linearGradient>
      <linearGradient id="g-rail-bronze" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0%" stopColor="#5A4D40" />
        <stop offset="30%" stopColor="#665848" />
        <stop offset="75%" stopColor="#382D22" />
      ...
      <filter id="f-wood" x="0%" y="0%" width="100%" height="100%" colorInterpolationFilters="sRGB">
        <feTurbulence type="fractalNoise" baseFrequency="0.01 0.6" numOctaves="5" seed="7" result="grain" />
        <feColorMatrix type="saturate" values="0.3" in="grain" result="tinted" />
        <feComponentTransfer in="tinted" result="contracted">
          <feFuncR type="linear" slope="1.6" intercept="-0.3" />
          <feFuncG type="linear" slope="1.5" intercept="-0.28" />
          <feFuncB type="linear" slope="1.4" intercept="-0.26" />
        </feComponentTransfer>
