  ...
  return (
    <svg viewBox={`0 0 ${W} 520`} style={{ width: '100%', height: '100%', display: 'block' }}>
      ...
      <defs>
        ...
        {deckColor?.img && (
          <pattern id="p-corner-img" patternUnits="userSpaceOnUse" width="200" height="200">
            <image href={deckColor.img} width="200" height="200" preserveAspectRatio="xMidYMid slice" />
          </pattern>
        )}
      </defs>
      ...
      <g clipPath="url(#cv-deck-top)">
        <rect x={0} y={BY - 12} width={W} height={180} fill={deckColor?.img ? "url(#p-corner-img)" : b} filter={deckColor?.img ? undefined : "url(#f-wood)"} />
